...
public class UserService {
    ...
    public User updateUser(Long id, String name, String email, String phoneNumber, String notificationPreference) {
        ...
        if (notificationPreference != null && !notificationPreference.isBlank()) {
            try {
                user.setNotificationPreference(User.NotificationPreference.valueOf(notificationPreference.toUpperCase()));
            } catch (IllegalArgumentException e) {
                throw new IllegalArgumentException("Invalid notification preference: " + notificationPreference
                        + ". Valid values are: EMAIL, SMS, BOTH");
            }
        }
